...
const { getAllUsers, signup, login, uploadImage, addUserDetails, 
    getCurrentUser, updateTeam, getTeam, getTeammates } = require('./handlers/users');
...
app.get('/user/team', FirebaseAuth, getTeam);           // get team name for user
app.get('/user/teammates', FirebaseAuth, getTeammates)  // get all teammates in the same team as the current user
